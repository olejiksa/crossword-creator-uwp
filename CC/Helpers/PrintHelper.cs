...
{
    /// <summary>
    /// Класс-помощник для работы с печатью.
    /// </summary>
    public class PrintHelper
    {
        ...
        /// </summary>
        protected EventHandler PreviewPagesCreated;

        /// <summary>
        /// First page in the printing-content series from this "virtual sized" paged content is split (text is flowing) to "printing pages".
        /// </summary>
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                Messages.PrintFileError("Error printing: " + e.Message + ", hr=" + e.HResult);
            }
        }
        ...
        protected virtual void PrintTaskRequested(PrintManager sender, PrintTaskRequestedEventArgs e)
        {
            ...
            printTask = e.Request.CreatePrintTask(Locator.FillingVM.GridFileName, sourceRequested =>
            {
        ...
        protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            if (lastRTBOAdded == null)
            {
                ...
                Grid footer = (Grid)page.FindName("Footer");
                footer.Visibility = Visibility.Visible;
            }
            else
            {
                //Flow content (text)from previous pages.
                page = new PrintListView();
            }
            ...
            double marginWidth = Math.Max(printPageDescription.PageSize.Width -
                printPageDescription.ImageableRect.Width, printPageDescription.PageSize.Width * ApplicationContentMarginLeft * 2);
            double marginHeight = Math.Max(printPageDescription.PageSize.Height -
                printPageDescription.ImageableRect.Height, printPageDescription.PageSize.Height * ApplicationContentMarginTop * 2);
